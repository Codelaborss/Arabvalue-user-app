...
class _ParcelRequestScreenState extends State<ParcelRequestScreen> {
  ...
  void initCall() {
    ...
    Get.find<CheckoutController>().getSurgePrice(
      zoneId: widget.pickedUpAddress.zoneId.toString(),
      moduleId: ModuleHelper.getModule()?.id.toString() ??
          (ModuleHelper.getCacheModule()?.id.toString() ?? '0'),
                                    ...
                                    children: [
                                      ...
                                      parcelController.offlineMethodList !=
                                          ...
                                          ? OfflinePaymentButton(
                                              ...
                                              disablePayment: parcelController
                                                  .offlineMethodList!.isEmpty,
                                              onTap: () {
                                                parcelController
