...
class PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    ...
    if (widget.addFundUrl == '' &&
      ...
      selectedUrl =
          '${AppConstants.baseUrl}/payment-mobile?customer_id=${widget.createAccount ? widget.createUserId : widget.orderModel.userId == 0 ? widget.guestId : widget.orderModel.userId}&order_id=${widget.orderModel.id}&payment_method=${widget.paymentMethod}&amount=${widget.orderModel.orderAmount}';
