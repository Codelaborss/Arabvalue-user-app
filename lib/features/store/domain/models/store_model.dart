...
class Store {
  ...
  Store.fromJson(Map<String, dynamic> json) {
    ...
    bonusConfiguration = json['bonus_configuration'];
...
class Availability {
  ...
  Availability({this.status, this.activeAt});
    ...
    if (json['images'] != null) {
      ...
      try {
        if (json['images'] is String) {
          List<dynamic> data = jsonDecode(json['images']);
          for (var v in data) {
            images!.add(v is String ? v : v['img'].toString());
          }
        } else {
