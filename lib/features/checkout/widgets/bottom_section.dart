...
class BottomSection extends StatelessWidget {
  ...
  static String _formatGiftPrice(double value) {
    bool isRightSide =
  ...
  static String _formatExactPrice(double value) {
    bool isRightSide =
        Get.find<SplashController>().configModel!.currencySymbolDirection ==
            'right';
    String symbol = Get.find<SplashController>().configModel!.currencySymbol!;
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child:
            ...
            ExtraDiscountViewWidget(
                extraDiscount: extraDiscount, isCashBack: isCashBack),
            const SizedBox(height: Dimensions.paddingSizeDefault),
                    ...
                    children: [
                        ...
                        Row(
                          children: [
                            ...
                            if (isGiftVoucher && bonus > 0) ...[
                              const SizedBox(
                                  width: Dimensions.paddingSizeExtraSmall),
                              Text(
                                _formatGiftPrice(total + bonus),
                                style: robotoRegular.copyWith(
        ...
        child: Column(
          children: [
                    ...
                    children: [
                      Row(
                          ...
                          children: [
                            ...
                            Text(
                                isGiftVoucher
                                    ? _formatGiftPrice(subTotal + bonus)
                                    : _formatExactPrice(subTotal),
                                style: robotoBold.copyWith(color: Colors.black),
                                textDirection: TextDirection.ltr),
                          ]),
                      const SizedBox(height: Dimensions.paddingSizeSmall),
                      if (isGiftVoucher || discount > 0 || isCashBack)
                        Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(
                              ...
                              Text(
                                  isCashBack
                                      ? _formatExactPrice(discount)
                                      : '${isGiftVoucher ? '(+) ' : '(-) '}${isGiftVoucher ? _formatGiftPrice(bonus) : _formatExactPrice(discount)}',
                                  style: robotoRegular.copyWith(
                                      color: Colors.black54),
                                  textDirection: TextDirection.ltr),
                            ]),
                      ...
                      const SizedBox(height: Dimensions.paddingSizeSmall),
                      if (isVoucherItem || isFlatDiscount) ...[
                        Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('Amount to Pay:',
                    ...
                    Row(
                        ...
                        children: [
                          ...
                          (couponController.coupon != null &&
                              ...
                              : Text(
                                  '(-) ${_formatExactPrice(couponController.discount ?? 0)}',
                                  style: robotoRegular,
                                  textDirection: TextDirection.ltr,
                                ),
                        ]),
                ...
                ? Column(children: [
                    Row(
                        ...
                        children: [
                          ...
                          Text(
                            '(-) ${_formatExactPrice(referralDiscount)}',
                            style: robotoRegular,
                            textDirection: TextDirection.ltr,
                          ),
                        ]),
            ...
            (AuthHelper.isGuestLoggedIn() &&
                    ...
                    (storeId == null || isGiftVoucher || isCashBack)
                ? const SizedBox()
                : Row(children: [
