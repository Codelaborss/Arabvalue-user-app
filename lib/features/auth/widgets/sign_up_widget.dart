...
class SignUpWidget extends StatefulWidget {
  final String? refId; // Add ref_id parameter

  const SignUpWidget({super.key, this.refId});
...
class SignUpWidgetState extends State<SignUpWidget> {
  ...
  void initState() {
    ...
    if (widget.refId != null) {
      _referCodeController.text = widget.refId!;
    }
  }
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Row(children: [
                          ...
                          Expanded(
                            child: CustomTextField(
                              ...
                              nextFocus:
                                  isDesktop ? _passwordFocus : _emailFocus,
                        ...
                        CustomButton(
                          ...
                          onPressed: authController.guestLoading
                              ? null
                              : () {
