    ...
    if (canRedirect) {
      bool isSuccess = forSubscription
          ? (url.contains('/subscription-success') ||
              url.contains('/subscription/cybersource/success'))
          : (url.contains('/payment-success') ||
              url.contains('/payment/cybersource/success'));
      bool isFailed = forSubscription
          ? (url.contains('/subscription-fail') ||
              url.contains('/subscription/cybersource/fail'))
          : (url.contains('/payment-fail') ||
              url.contains('/payment/cybersource/fail'));
      bool isCancel = forSubscription
          ? (url.contains('/subscription-cancel') ||
              url.contains('/subscription/cybersource/cancel'))
          : (url.contains('/payment-cancel') ||
              url.contains('/payment/cybersource/cancel'));
