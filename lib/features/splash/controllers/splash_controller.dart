...
class SplashController extends GetxController implements GetxService {
  ...
  bool _showFlashSaleDialog = true;
  bool get showFlashSaleDialog => _showFlashSaleDialog;

  void setFlashSaleDialogStatus(bool status) {
    _showFlashSaleDialog = status;
    update();
  }
  ...
  Module getModuleConfig(String? moduleType) {
    Module module = Module.fromJson((_data != null ? _data!['module_config'][moduleType] : null) ?? {});
    if (moduleType != null) {
      (moduleType == 'food' || moduleType == 'voucher')
