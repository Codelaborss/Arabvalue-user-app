...
class SpecialCriterias {
  ...
  SpecialCriterias.fromJson(Map<String, dynamic> json) {
    ...
    status = int.tryParse(json['status'].toString());  // ✅ Fixed
...
class DownloadUserAppLinks {
  int? playstoreUrlStatus;  // ✅ Fixed: String se int
  String? playstoreUrl;
  int? appleStoreUrlStatus;  // ✅ Fixed: String se int
  ...
  DownloadUserAppLinks.fromJson(Map<String, dynamic> json) {
    playstoreUrlStatus = int.tryParse(json['playstore_url_status'].toString());  // ✅ Fixed
    playstoreUrl = json['playstore_url'];
    appleStoreUrlStatus = int.tryParse(json['apple_store_url_status'].toString());  // ✅ Fixed
