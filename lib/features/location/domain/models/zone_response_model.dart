...
class Pivot {
 ...
 Pivot.fromJson(Map<String, dynamic> json) {
  ...
  perKmShippingCharge = _parseToDouble(json['per_km_shipping_charge']);
  minimumShippingCharge = _parseToDouble(json['minimum_shipping_charge']);
  maximumShippingCharge = _parseToDouble(json['maximum_shipping_charge']);
  maximumCodOrderAmount = _parseToDouble(json['maximum_cod_order_amount']);
  deliveryChargeType = json['delivery_charge_type'];
  fixedShippingCharge = _parseToDouble(json['fixed_shipping_charge']);
}

// Helper method add karo Pivot class ke andar
