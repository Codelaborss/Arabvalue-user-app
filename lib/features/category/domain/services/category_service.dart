...
class CategoryService implements CategoryServiceInterface {
  ...
  @override
  Future<StoreModel?> getCategoryStoreList(String? categoryID, int offset, String type, {bool isGift = false}) async {
    return await categoryRepositoryInterface.getList(id: categoryID, offset: offset, type: type, categoryStoreList: true, isGift: isGift);
  }
