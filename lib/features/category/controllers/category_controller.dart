...
class CategoryController extends GetxController implements GetxService {
  ...
  void getCategoryStoreList(
    ...
    StoreModel? categoryStore = await categoryServiceInterface
        .getCategoryStoreList(categoryID, offset, type, isGift: isGift);
  ...
  List<Item>? getFilteredItems({bool searching = false}) {
    List<Item>? itemsToFilter = searching ? _searchItemList : _categoryItemList;
    if (itemsToFilter == null) return null;
      ...
      if (_voucherFilter == 'Voucher Type' || _voucherFilter == 'all') {
        ...
        matchesFilter = (item.voucherIds != null &&
            ...
            (item.voucherType != null &&
                item.voucherType!.contains(filterToSearch)) ||
            (item.offerType != null &&
                item.offerType!.contains(filterToSearch));
      }
