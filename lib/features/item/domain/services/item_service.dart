...
class ItemService implements ItemServiceInterface {
  ...
  @override
  Future<List<Item>?> getHotVoucherList(DataSourceEnum? source) async {
    return await itemRepositoryInterface.getList(
        isHotVoucher: true, source: source);
  }

  @override
  Future<List<Item>?> getNewVoucherList(DataSourceEnum? source) async {
    return await itemRepositoryInterface.getList(
        isNewVoucher: true, source: source);
  }
