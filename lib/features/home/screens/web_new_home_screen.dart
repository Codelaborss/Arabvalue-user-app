...
import 'package:sixam_mart/features/home/widgets/web/web_hot_voucher_view_widget.dart';
import 'package:sixam_mart/features/home/widgets/web/web_new_voucher_view_widget.dart';
import 'package:sixam_mart/features/home/widgets/web/web_recommended_voucher_view_widget.dart';
import 'package:sixam_mart/features/home/widgets/web/web_voucher_recommended_store_view_widget.dart';
...
class _WebNewHomeScreenState extends State<WebNewHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isVoucher = Get.find<SplashController>().module != null &&
        Get.find<SplashController>().module!.moduleType.toString() ==
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        (isPharmacy || isFood)
                            ? const SizedBox()
                            : isShop
                                ? const WebNewOnViewWidget(isFood: false)
                                : const WebNewOnMartViewWidget(),
                        isFood
                            ? const SizedBox()
