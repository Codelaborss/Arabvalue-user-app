...
import 'package:sixam_mart/features/home/widgets/flash_sale_dialog_widget.dart';
...
import 'package:sixam_mart/features/home/screens/modules/voucher_home_screen.dart';
...
import 'package:sixam_mart/helper/user_stats_helper.dart';
    ...
    if (Get.find<SplashController>().module != null &&
      ...
      Get.find<ItemController>().getRecommendedItemList(
          ...
          Get.find<SplashController>().module?.moduleType ==
              ...
              : 'all',
          false);
      Get.find<ItemController>().getHotVoucherList(reload, false);
      Get.find<ItemController>().getNewVoucherList(reload, false);
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _showFlashSaleDialog() {
    ...
    if (!splashController.showFlashSaleDialog) {
      return;
    }
    splashController.setFlashSaleDialogStatus(false);

    // Delay to ensure UI is fully built
    Future.delayed(const Duration(milliseconds: 1500), () {
      final flashSaleController = Get.find<FlashSaleController>();

      // Check if flash sale data is available and has products
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SplashController>(builder: (splashController) {
      ...
      bool isVoucher = splashController.module != null &&
          splashController.module!.moduleType.toString() ==
              AppConstants.voucher;
                  ...
                  child: RefreshIndicator(
                    onRefresh: () async {
                      ...
                      if (Get.find<SplashController>().module != null &&
                        ...
                        Get.find<ItemController>()
                            .getHotVoucherList(true, true);
                        Get.find<ItemController>()
                            .getNewVoucherList(true, true);
