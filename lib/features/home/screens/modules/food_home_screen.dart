...
class FoodHomeScreen extends StatefulWidget {
  ...
  const FoodHomeScreen({super.key, this.scrollController});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CategoryController>(builder: (categoryController) {
      return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
            key: _newVoucherKey,
            child: const NewVoucherView(isFood: true, isShop: false)),
        Container(key: _bestStoreKey, child: const BestStoreNearbyView()),
        Container(
            key: _specialOfferKey,
            child: const SpecialOfferView(isFood: true, isShop: false)),
        Container(
            key: _itemYouLoveKey,
            child: const ItemThatYouLoveView(forShop: false)),
        Container(
            key: _mostPopularKey,
            child: const MostPopularItemView(isFood: true, isShop: false)),
