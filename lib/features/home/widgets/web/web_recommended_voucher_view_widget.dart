...
class WebRecommendedVoucherViewWidget extends StatefulWidget {
  const WebRecommendedVoucherViewWidget({super.key});

  @override
  State<WebRecommendedVoucherViewWidget> createState() =>
      _WebRecommendedVoucherViewWidgetState();
}

class _WebRecommendedVoucherViewWidgetState
    extends State<WebRecommendedVoucherViewWidget> {
