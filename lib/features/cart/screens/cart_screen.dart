    ...
    return GetBuilder<CartController>(builder: (cartController) {
      return Scaffold(
          ...
          appBar: CustomAppBar(
            ...
            onClearTap: cartController.cartList.isNotEmpty
                ? () {
                    Get.dialog(ConfirmationDialog(
                      icon: Images.profileDelete,
                      description: 'are_you_sure_to_reset'.tr,
                      onYesPressed: () => cartController.clearCartOnline(),
                    ));
                  }
                : null,
          ),
                                                              ...
                                                              children: [
                                                                  ...
                                                                  child: ListView
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return CartItemWidget(
                                                                          ...
                                                                          cartIndex:
                                                                              index,
                                                                          addOns: cartController.addOnsList[
                                                                              index],
                                                                          isAvailable: cartController.availableList[
                                                                              index],
                                                                          showDivider:
                                                                ...
                                                                Center(
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                        () {
                                                                      cartController.forcefullySetModule(cartController
                                                                          .cartList[
                                                                              0]
                                                                          .item!
                                                                          .moduleId!);
                                                                      Get.toNamed(
                                                                        ...
                                                                        arguments: StoreScreen(
                                                                            store:
                                                                                Store(id: cartController.cartList[0].item!.storeId),
                                                                            fromModule: false),
                                                                      );
                                                                    },
                                                                    icon: Icon(
