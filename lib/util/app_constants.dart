...
class AppConstants {
  static const String appName = 'Arabi Value';
  static const double appVersion = 3.3;

  ///Flutter sdk 3.32.8

  static const String fontFamily = 'Myriad Pro';
  static const bool payInWevView = false;
  static const int balanceInputLen = 10;
  static const String webHostedUrl = 'https://fortestingweb.com';
  static const bool useReactWebsite = false;

  static const String baseUrl = 'https://fortestingweb.com';
  ...
  static const String hotVoucherUri = '/api/v1/items/hot-voucher';
  static const String newVoucherUri = '/api/v1/items/new-voucher';
  ...
  static const String giftAllStoreUri = '/api/v1/categories/stores/gift-all/';
  ...
  static const String checkRefIdUri = '/api/v1/check-ref-id';
  ...
  static const String giftOccasionsUri = '/api/v1/voucher/gift-occasions';
  static const String giftMessageUri = '/api/v1/voucher/msg-template';
  static const String storeItemsUri = '/api/v1/items/store/';
  ...
  static const String clientApiThemes = 'client_api_themes';
  ...
  static const String clientData = 'client_data';
  static const String clientAppData = 'client_app_data';
  ...
  static const String dayWise = 'day_wise';
    ...
    static String partnerLabel(bool showRestaurantText) {
        return showRestaurantText ? 'partners'.tr : 'stores'.tr;
    }
}
