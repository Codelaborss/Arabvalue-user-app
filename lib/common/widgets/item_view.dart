              ...
              ? GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    ...
                    mainAxisExtent:
                        ResponsiveHelper.isDesktop(context) && widget.isStore
                            ? (widget.isPartner ? 180 : 220)
                            : ResponsiveHelper.isMobile(context)
                                ? widget.stores != null && widget.isStore
                                    ? (widget.isPartner ? 190 : 200)
                                    : widget.isStoreItem
                                        ? 120
                                        : 341
                  ...
                  itemBuilder: (context, index) {
                    return widget.stores != null && widget.isStore
                        ...
                        : widget.isStoreItem
                            ? StoreItemWidget(
                                item: widget.items![index]!, index: index)
                            : !ResponsiveHelper.isDesktop(context)
                                ? ItemWidget(
...
class PartnerStoreShimmer extends StatelessWidget {
  const PartnerStoreShimmer({super.key});
