...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  final Function? onClearTap; // Added for 'Delete All' functionality
  ...
  Widget build(BuildContext context) {
    return ResponsiveHelper.isDesktop(context)
        ...
        : AppBar(
            ...
            surfaceTintColor: bgColor ?? Theme.of(context).cardColor,
  ...
  @override
  Size get preferredSize => Size(Get.width,
      height ?? (ResponsiveHelper.isDesktop(Get.context!) ? 100 : 50));
}
