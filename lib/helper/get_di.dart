...
import 'package:sixam_mart/features/gift/domain/repositories/gift_repository.dart';
import 'package:sixam_mart/features/gift/domain/repositories/gift_repository_interface.dart';
import 'package:sixam_mart/features/gift/domain/services/gift_service.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  /// Gift
  GiftRepositoryInterface giftRepositoryInterface = GiftRepository(apiClient: Get.find());
  Get.lazyPut(() => giftRepositoryInterface);
  GiftServiceInterface giftServiceInterface = GiftService(giftRepositoryInterface: Get.find());
  Get.lazyPut(() => giftServiceInterface);
  ...
  Get.lazyPut(() => GiftController(giftServiceInterface: Get.find()));
    Get.lazyPut(() => DynamicThemeController(
