...
import 'package:sixam_mart/features/gift/screens/giftscreen1.dart';
import 'package:sixam_mart/features/gift/screens/giftscreen2.dart';
import 'package:sixam_mart/features/gift/screens/giftscreen3.dart';
import 'package:sixam_mart/features/gift/screens/giftscreen4.dart';
import 'package:sixam_mart/features/gift/screens/giftscreen5.dart';
import 'package:sixam_mart/features/gift/screens/giftscreen6.dart';
import 'package:sixam_mart/features/gift/screens/giftscreen7.dart';
import 'package:sixam_mart/features/gift/screens/giftscreen8.dart';
import 'package:sixam_mart/features/gift/screens/gift_voucher_list_screen.dart';
import 'package:sixam_mart/features/auth/controllers/auth_controller.dart';
import 'package:sixam_mart/features/auth/screens/new_user_setup_screen.dart';
import 'package:sixam_mart/features/auth/screens/pin_code_login.dart';
...
class RouteHelper {
  ...
  static const String gift2 = '/gift-2';
  static const String gift3 = '/gift-3';
  static const String gift4 = '/gift-4';
  static const String gift5 = '/gift-5';
  static const String gift6 = '/gift-6';
  static const String gift7 = '/gift-7';
  static const String gift8 = '/gift-8';
  static const String giftVoucherList = '/gift-voucher-list';
  ...
  static String getSignInRoute(String page) =>
      ResponsiveHelper.isDesktop(Get.context)
          ? '$signIn?page=$page'
          : pinCodeLogin;
  static String getSignUpRoute() => signUp;
  static String getPinCodeLoginRoute() => pinCodeLogin;
  ...
  static String getPaymentRoute(String id, int? user, String? type,
      ...
      '$payment?id=$id&user=$user&type=$type&amount=$amount&cod-delivery=$codDelivery&add-fund-url=$addFundUrl&payment-method=$paymentMethod&guest-id=$guestId&number=$contactNumber&subscription-url=$subscriptionUrl&store_id=$storeId&create_account=$createAccount&create_user_id=$createUserId&is_voucher=$isVoucher&is_flat=$isFlat&discount_amount=$discountAmount';
  ...
  static String getGiftRoute() => gift;
  static String getGiftVoucherListRoute(int? storeId) =>
      '$giftVoucherList?store_id=$storeId';
  static String getGiftRoute2() => gift2;
  static String getGiftRoute3(GiftOccasionModel occasion) {
    String data = base64Url.encode(utf8.encode(jsonEncode(occasion.toJson())));
    return '$gift3?occasion=$data';
  }

  static String getGiftRoute4() => gift4;
  static String getGiftRoute5() => gift5;
  static String getGiftRoute6() => gift6;
  static String getGiftRoute7() => gift7;
  static String getGiftRoute8() => gift8;
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: pinCodeLogin, page: () => const PinCodeLogin()),
    GetPage(
        name: verification,
        page: () {
          String? pass;
    ...
    GetPage(name: menu, page: () => const MenuScreen()), // Add this line
    ...
    GetPage(
        ...
        page: () {
          OrderModel order = OrderModel(
            ...
            voucherType: Get.parameters['is_voucher'] == 'true'
                ? (Get.parameters['is_flat'] == 'true' ? 'flat' : 'voucher')
                : null,
            storeDiscountAmount:
                double.tryParse(Get.parameters['discount_amount'] ?? '0') ??
                    0.0,
          );
    ...
    GetPage(name: gift, page: () => const GiftScreen1()),
    GetPage(
        name: giftVoucherList,
        page: () => GiftVoucherListScreen(
            storeId: Get.parameters['store_id'] != 'null'
                ? int.parse(Get.parameters['store_id']!)
                : null)),
    GetPage(name: gift2, page: () => const GiftScreen2()),
    GetPage(
        name: gift3,
        page: () {
          List<int> decode =
              base64Decode(Get.parameters['occasion']!.replaceAll(' ', '+'));
          GiftOccasionModel data =
              GiftOccasionModel.fromJson(jsonDecode(utf8.decode(decode)));
          return GiftScreen3(occasion: data);
        }),
    GetPage(name: gift4, page: () => const GiftScreen4()),
    GetPage(name: gift5, page: () => const GiftScreen5()),
    GetPage(name: gift6, page: () => const GiftScreen6()),
    GetPage(name: gift7, page: () => const GiftScreen7()),
    GetPage(name: gift8, page: () => const GiftScreen8()),
